"""Artifact validation contracts for pipeline stage outputs.

Moved from graphids.config.schema to graphids.storage where they belong
(contracts validate filesystem artifacts, which is storage-layer concern).
Backward-compatible re-exports remain in graphids.config.__init__.
"""
