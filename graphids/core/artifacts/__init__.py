...
Public API:
    ...
    generate_all(cfg, val_data, device, output_dir, artifacts, load_model_fn=...)
"""
...
def generate_all(
    ...
    *,
    ...
    Args:
        ...
        load_model_fn: Callable(cfg, model_type, stage, device) -> nn.Module.
            Required for CKA and loss landscape. Passed by the evaluation stage
            to avoid core→pipeline import.
    """
