...
from graphids.slurm.env import EPILOG_PATH, PREAMBLE_PATH, SLURM_ACCOUNT, SLURM_LOG_DIR
...
def poll(job_id: int, *, interval: int = 60, max_unknown: int = 5, on_state=None) -> str:
