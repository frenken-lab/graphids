// Ablation: supervised stage, locked conv_type='gps'.
...
function(
  ...
  std.mergePatch(
    ...
    run_dir=std.native('paths.run_dir')(dataset, 'conv_type', 'gps', seed),
    conv_type='gps', loss_fn=loss_fn, sampler=sampler,
    ckpt_path=ckpt_path,
