// Ablation: supervised stage, locked conv_type='gatv2'.
...
function(
  ...
  std.mergePatch(
    ...
    run_dir=std.native('paths.run_dir')(dataset, 'conv_type', 'gatv2', seed),
    conv_type='gatv2', loss_fn=loss_fn, sampler=sampler,
    ckpt_path=ckpt_path,
